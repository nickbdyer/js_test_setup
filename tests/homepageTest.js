...
describe('Visiting the homepage', function() {
  ...
  it('solves a puzzle in the table', function(done) {
    client
      .setValue('#sudokustring', '53..7....6..195....98....6.8...6...34..8.3..17...2...6.6....28....419..5....8..79')
      .click('#solve')
      .waitForValue('/html/body/center/table/tbody/tr[1]/td[3]/input', 1000)
      .getValue('/html/body/center/table/tbody/tr[1]/td[3]/input', function(err, value) {
